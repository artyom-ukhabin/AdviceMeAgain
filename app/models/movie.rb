class Movie < Content
  has_and_belongs_to_many :genres, class_name: 'MovieGenre', association_foreign_key: 'movie_genre_id',
    foreign_key: :content_id

  scope :with_genre_name, ->(genre_name) { joins(:genres).where('movie_genres.name = ?', genre_name) }
