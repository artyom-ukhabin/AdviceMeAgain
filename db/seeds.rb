...
User.create!(email: 'test_3@example.com', role: :regular, password: 'password', password_confirmation: 'password')
User.create!(email: 'test_4@example.com', role: :regular, password: 'password', password_confirmation: 'password')
